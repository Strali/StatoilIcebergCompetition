...
from keras.layers import Conv2D, MaxPooling2D, GlobalAveragePooling2D, Dense, Dropout, BatchNormalization, Input, Flatten, Activation
...
if USE_AUGMENTATION:
    ...
    model.fit_generator( image_augmentation.flow(X_train, y_train), steps_per_epoch = 4096/BATCH_SIZE, epochs = EPOCHS,
